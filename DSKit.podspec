...
Pod::Spec.new do |s|
  s.name             = 'DSKit'
  s.version          = '0.1.0'
  s.summary          = 'Design system kit para empresa Chronus Tecnologia'
...
TODO: Add long description of the pod here.
  ...
  s.source           = { :git => 'https://github.com/chronustecnologia/mobile-ios-dskit-chronus.git', :tag => s.version.to_s }
